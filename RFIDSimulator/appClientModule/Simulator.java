		...
		if (e.getSource() == this.jb_start) {
			new Thread(new Runnable() {
				...
				public void run() {
					...
					PICC deviceA = new PICC("A", jl_a_state, jl_a_R);
					PICC deviceB = new PICC("B", jl_b_state, jl_b_R);
					PICC deviceC = new PICC("C", jl_c_state, jl_c_R);
					...
					m_pcd = new PCD(devices, jl_current);
					m_pcd.run();
				}
